...
if __name__ == '__main__':
    ...
    csv_byrun.write("run,name,ra_hms,dec_dms,night,observer,temp_avg,hum_avg,lost_weather,lost_technical,lost_other,comments_weather,comments_night,comments_exposure\n")
